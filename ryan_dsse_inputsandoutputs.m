...
% Pull nodal admittance matrix (Y) from OpenDSS
...
[sorted_y_node,sort_index] =  sort(ynode_order);  % sorted y nodes stored in sorted_y_node
...
%%
%  Optimize to find GFT coefficients
%
%
%
