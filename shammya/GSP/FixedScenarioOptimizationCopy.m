...
% sensor_locations = 1:85;
 % 64 Sensors for the 85 bus test case 
sensor_locations = [38 22 84 62 47 39 24 79 51 44 78 75 43 82 54 37 71 59 16 31 15 23 36 81 4 5 8 9 60 26 41 1 6 19 18 20 63 10 21 3 29 28 35 70 49 50 25 12 32 52 53 42 33 13 7 48 80 57 27 72 67 64 77 66];
...
save('85Bus_64Sensors.mat','rmse_angle','rmse_voltage','max_angle','max_voltage','failed_scenario')
