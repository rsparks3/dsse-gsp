...
rng(1)
define_constants;
SENSOR_PER_CLUSTER = 24;ncluster=1;number_of_eigenvectors=24;
...
save(strcat(casestr,'_no_clustering_scenario_ami.mat'),'failed_scenario','estimated_angle','actual_angle','estimated_voltage','actual_voltage','sensor_locations')
