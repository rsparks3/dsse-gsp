...
rng(1)
define_constants;
ncluster=1;number_of_eigenvectors=24;
...
SENSOR_PER_CLUSTER = ceil(nb*0.5);
...
% save(strcat(casestr,'_clustering_scenario_noloss.mat'),'failed_scenario','estimated_angle','actual_angle','estimated_voltage','actual_voltage','sensor_locations')
